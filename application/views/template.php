    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url() ?>">PT. ABAMITA</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url().'barang/masuk'?>"><i class="fa fa-bar-chart-o"></i>Barang Masuk</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'pelanggan'?>"><i class="fa fa-user"></i>Data Pelanggan </a>
                    </li>
					<li>
